...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    ...
    <div class="col-span-12 space-y-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl text-gray-400 font-bold">Liste des Clients</h1>
                    ...
                    @forelse($clients as $client)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex gap-2">
                                <button title="Modifier" onclick="openEditModal({{ json_encode($client) }})" class="p-2 bg-yellow-100 rounded hover:bg-yellow-200 transition">✎</button>
                                <button onclick="openDeleteModal('{{ route('clients.destroy', $client->id) }}')" title="Supprimer" class="p-2 bg-red-100 rounded hover:bg-red-200 transition">✕</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-gray-500">Aucun client trouvé</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<div id="addClientModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white max-w-lg rounded-xl shadow-lg p-6 relative">
